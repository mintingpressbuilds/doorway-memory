...
### 4.1 Update memory.py

Update the Memory class to integrate all Phase 2 and Phase 3 mechanics:
...
__all__ = ["Memory", "Shape", "Dimension", "Library", "Tier2Shape"]
```
...
- API reference: store, recall, is_known, is_void
...
- `from doorway_memory import Memory, Shape, Dimension` works
